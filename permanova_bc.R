...
# export table
write.table(permanova.result, file="results/permanova_bray_curtis.txt", sep="\t", row.names=F, quote=F)
write.table(cap.result, file="results/cap_bray_curtis.txt", sep="\t", row.names=F, quote=F)